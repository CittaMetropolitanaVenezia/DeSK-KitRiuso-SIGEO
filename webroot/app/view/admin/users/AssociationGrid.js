Ext.define('SIO.view.admin.users.AssociationGrid', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.admin.users.associationgrid',
    ...
    initComponent: function() {
        ...
        var associationsStore = Ext.getStore('Associations');
        ...
        var r = Ext.create('SIO.model.Association');		
