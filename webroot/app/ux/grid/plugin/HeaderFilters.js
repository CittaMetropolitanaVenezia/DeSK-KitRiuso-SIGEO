 ...
 * @version 0.2.0
 */
Ext.define('SIO.ux.grid.plugin.HeaderFilters',{

    ptype: 'gridheaderfilters',
    //alternateClassName: ['SITI.ux.HeaderFilters', 'Ext.ux.grid.header.Filters'],
        ...
        for(var c=0; c < columns.length; c++)
        {
            ...
            if(column.filter)
            {
                ...
                for(var ci = 0; ci < fca.length; ci++)
                {
                    ...
                    filterField.on('change', function(field, newValue, oldValue) {
                        if (newValue == '') this.onFilterContainerEnter();
                    }, this);
