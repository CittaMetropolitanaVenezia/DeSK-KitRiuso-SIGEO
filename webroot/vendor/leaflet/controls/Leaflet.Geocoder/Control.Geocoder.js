(function (factory) {
	...
	L.Control.Geocoder = L.Control.extend({
		...
		onAdd: function (map) {
            ...
            icon.title = this.options.tooltip;
		...
		markGeocode: function(result) {
            ...
            if (this.options.markerIcon) this._geocodeMarker = new L.Marker(result.center, { icon: this.options.markerIcon });
            else this._geocodeMarker = new L.Marker(result.center);
            ...
            if (this.options.removeMarkerTimeout) {
                var map = this._map,
                    marker = this._geocodeMarker;
                setTimeout(function() {
                    map.removeLayer(marker);
                }, this.options.removeMarkerTimeout);
            }
